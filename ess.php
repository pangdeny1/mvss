...
$ModuleList = array(_('ESS'), _('Setup'));
				...
				<table width="100%">
					...
					<td class="menu_group_items">
						<table width="100%"class="table_index">
							...
							<tr>
							<td class="menu_group_item">
								<?php echo "<a href='" . $rootpath . '/prlSelectAreas.php?' . SID . "'><li>" . _('Salary Areas/Bonus') . '</li></a>'; ?>
							</td>
							</tr>
							<tr>
							<td class="menu_group_item">
								<?php echo "<a href='" . $rootpath . '/prlRegTimeEntry.php?' .SID . "'><li>" . _('Time Sheet Data Entry') . '</li></a>'; ?>
							</td>
							</tr>							
							<tr>
							<td class="menu_group_item">
							...
							<tr>
							<td class="menu_group_item">
								<?php echo "<a href='" . $rootpath . '/prlSelectAbsent.php?' .SID . "'><li>" . _('Absents  Data Entry') . '</li></a>'; ?>
							</td>
							</tr> 
							<tr>
							<td class="menu_group_item">
							...
							<tr>
							<td class="menu_group_item">
								<?php echo "<a href='" . $rootpath . '/prlSelectRT.php?' . SID . "'><li>" . _('View Time Sheet') . '</li></a>'; ?>
							</td>
							</tr>						
							<tr>
							<td class="menu_group_item">
							...
							<tr>
							<td class="menu_group_item">
								<?php echo "<a href='" . $rootpath . '/prlSelectDeduction.php?' . SID . "'><li>" . _('View Payroll Loan Deduction') . '</li></a>'; ?>
							</td>
							</tr>
							<!--<tr>
							<td class="menu_group_item">
...
<tr>
<td class="menu_group_headers"><div align="center">Update Statutory</div>
								<tr>
								<td class="menu_group_item">
									<?php echo "<a href='" . $rootpath . '/prlUpdateEmployeeStatutory.php?' . SID . "'><li>" . _('Update Employee Statutory') . '</li></a>'; ?>
								</td>	
</tr>								
					...
					<td class="menu_group_items">
							...
							<tr>
							<td class="menu_group_item">
								<?php echo "<a href='" . $rootpath . '/prlRepCashTrans.php?' . SID . "'><li>" . _('Cash Payment Listing') . '</li></a>'; ?>
							</td>
							</tr>
							...
							<td class="menu_group_headers"><div align="center">Year to Date Report</div>
								<tr>
								<td class="menu_group_item">
									<?php echo "<a href='" . $rootpath . '/prlRepPayrollRegYTD.php?' . SID . "'><li>" . _('Year To Date(YTD) Payroll Register') . '</li></a>'; ?>
								</td>
								</tr>
								<tr>
								<td class="menu_group_item">
									<?php echo "<a href='" . $rootpath . '/prlRepTaxYTD.php?' . SID . "'><li>" . _('YTD Tax') . '</li></a>'; ?>
								</td>
								</tr>
							</td>
							<td class="menu_group_headers"><div align="center">Diskette Report</div>
								<tr>
								<td class="menu_group_item">
									<?php echo "<a href='" . $rootpath . '/prlSelectEmployee_bk2.php?' . SID . "'><li>" . _('Monthly Alphalist of Payees(MAP)') . '</li></a>'; ?>
								</td>
								</tr>
								<tr>
								<td class="menu_group_item">
									<?php echo "<a href='" . $rootpath . '/notyet.php?' . SID . "'><li>" . _('Pension R3 Diskette') . '</li></a>'; ?>
								</td>
								</tr>
<tr>
								<td class="menu_group_headers"><div align="center">Employees Report</div>
								<tr>
								<td class="menu_group_item">
									<?php echo "<a href='" . $rootpath . '/prlRepEmployeeListing.php?' . SID . "'><li>" . _('Employee Listing Report') . '</li></a>'; ?>
								</td>
