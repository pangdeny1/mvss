...
if (isset($_POST['submit'])) {
   exit("Contact Administrator...");
	...
	$sql = "SELECT counterindex,payrollid,employeeid,grosspay,loandeduction,sss,hdmf,philhealth,tax,heslb
	...
	if(DB_num_rows($PayDetails)>0)
	{
		...
		{	
				$NetPay=$myrow['grosspay']-$myrow['loandeduction']-$myrow['sss']-$myrow['hdmf']-$myrow['philhealth']-$myrow['tax'] -$myrow['heslb'];
