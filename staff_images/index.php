...
<?php // include ('modal_add.php'); ?>
                        ...
                        <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                            <div class="alert alert-info">
                                ...
                                <strong><i class="icon-user icon-large"></i>&nbsp;Employees Image</strong>
                            </div>
                            <thead>
                                <tr>
							...
							<?php
								require_once('db.php');
								$result = $conn->prepare("SELECT * FROM prlemployeemaster ");
								$result->execute();
							...
							?>
								...
								<td style="text-align:center; margin-top:10px; word-break:break-all; width:450px; line-height:100px;">
									<?php if($row['employeepicture'] != ""): ?>
									<img src="uploads/<?php echo $row['employeepicture']; ?>" width="100px" height="100px" style="border:1px solid #333333;">
									<?php else: ?>
							...
							<?php endif; ?>
							<b style="color:blue; margin-left:25px; font-size:30px;"><?php echo $row['firstname']." ".$row['lastname']; ?></b>
							<br />
							...
							<div class="alert alert-danger">
							<?php if($row['employeepicture'] != ""): ?>
							<img src="uploads/<?php echo $row['employeepicture']; ?>" width="100px" height="100px" style="border:1px solid #333333; margin-left: 30px;">
							<?php else: ?>
