...
<a href="../index.php">Main Menu</a><center>Use Buttons below to Backup or Restore database</center>
<hr>

    <center>
	
	<form name="import" action="" method="POST" enctype="multipart/form-data">
        <label>File to Restore from: </label><input type="file" name="rfile" /><input type="submit" name="restore" value="Restore">
        <p>
		<select name="database">
		<option value="">select database</option>
		<option value="">Miles Database</option>
	</select>
            <input type="submit"  name="backup" value="Backup">
            
        </p>
    </form></center>
	<hr><a href="../index.php">Back</a><center>
</body>