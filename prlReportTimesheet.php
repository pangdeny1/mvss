...
/* Standard PDF file creation header stuff */
	$pdf->addinfo('Title', _('Invoice Actual Cost') );
	$pdf->addinfo('Subject', _('Invoice Actual Cost') );
	...
	$sql = "SELECT employeeid,basicpay,othincome,taxableincomen,otherdeduction,absent,areaspay,late,otpay,grosspay,loandeduction,sss,hdmf,tax,netpay
			...
			WHERE stationid='".$_POST['StationID']."' AND prlpayrolltrans.payrollid='" .$_POST['PayrollID']. "'";
...
elseif (isset($_POST['PrintExcell'])) {
	   ...
	   echo 'Use PrintPDF instead';
	   echo "<BR><A HREF='" .$rootpath ."/index.php?" . SID . "'>" . _('Back to the menu') . '</A>';*/
	   include('prlReportTimesheetExcell.php');
	   exit;
} 
	...
	echo "<P><CENTER><INPUT TYPE='Submit' NAME='PrintExcell' VALUE='" . _('Print Excell') . "'>";
